...
t_tipoquantita_controller = Blueprint('t_tipoquantita', __name__)
...
@t_tipoquantita_controller.route('/create_tipoquantita', methods=['POST'])
...
@t_tipoquantita_controller.route('/delete_tipoquantita/<int:id>', methods=['DELETE'])
